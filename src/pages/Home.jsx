...
const Home = () => {
  return (
    <div className='Home-main'>
      ...
      <Timeline year={2026} heading={"Master of Computer Application"} description={"Sigma Institute of Engineering, Vadodara"}/>
      ...
      <Timeline year={2024} heading={"Bachelor of Science in Information Technology"} sub={"Secured CGPA 9.21/10.00"} description={"Parul Institute of Computer Application, Vadodara"}/>
